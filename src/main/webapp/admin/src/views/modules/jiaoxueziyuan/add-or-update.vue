                ...
                <el-col :span="12">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaoxueziyuanVideo" label="资源视频" prop="jiaoxueziyuanVideo">
                            <video :src="ruleForm.jiaoxueziyuanVideo" width="100" height="100" controls="controls">
                            </video>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaoxueziyuanFile" label="课件下载" prop="jiaoxueziyuanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.jiaoxueziyuanFile"  >课件下载下载</a>
                        </el-form-item>
                    </div>
                </el-col>
